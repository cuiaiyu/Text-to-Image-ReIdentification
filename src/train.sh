...
export CKPT_EXP='dist_fn_cosine_imgbb_resnet101_capbb_bigru_embed_size_1024_batch_96_lr_0.0002_step_size_10_captype_sent_img_meltlayer_6_np_False_sent_60_cap_10_6_both_fc_mute_layer1fmap'
...
--batch_size 96 \
--num_gpus 2 \
--img_backbone_opt resnet101 \
--cap_backbone_opt bigru \
--dist_fn_opt "cosine" \
--cap_embed_type sent \
--image_melt_layer 6 \
--step_size 10 \
--note "sent_60_cap_10_6_both_fc_mute_layer1fmap" \
